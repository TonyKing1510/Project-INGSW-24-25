...
@Setter
@NoArgsConstructor
public class AddGestoreRequestDTO extends AddBaseDTO {
    ...
    public boolean equals(Object obj) {
        ...
        AddGestoreRequestDTO other = (AddGestoreRequestDTO) obj;
        return Objects.equals(getNome(), other.getNome()) &&
                ...
                Objects.equals(cfGestoreAdmin, other.cfGestoreAdmin);
    }
    @Override
    public int hashCode() {
        return Objects.hash(getNome(), getCognome(), getCf(), getTelefono(), getPassword(), getEmail(), cfGestoreAdmin);
    }
}
